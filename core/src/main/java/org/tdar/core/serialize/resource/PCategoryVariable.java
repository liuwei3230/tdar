 ...
 */
public class PCategoryVariable extends AbstractPersistable implements Comparable<PCategoryVariable> {

    private String name;
    private String label;
    private String description;
    private CategoryType type;
    private PCategoryVariable parent;
    private Set<PCategoryVariable> children = new LinkedHashSet<>();
    ...
    public PCategoryVariable getParent() {
        return parent;
    }

    public void setParent(PCategoryVariable parent) {
        this.parent = parent;
    }
    ...
    @XmlTransient
    public Set<PCategoryVariable> getChildren() {
        return children;
    }

    public void setChildren(Set<PCategoryVariable> children) {
        this.children = children;
    }

    @Override
    public int compareTo(PCategoryVariable candidate) {
    ...
    @Transient
    public SortedSet<PCategoryVariable> getSortedChildren() {
