...
public class PPerson extends PCreator<PPerson> implements Comparable<PPerson> {
    ...
    public PPerson(String firstName, String lastName, String email) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
    }

    public PPerson(String firstName, String lastName, String email, Long id) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
        setId(id);
    ...
    public void setName(String name) {
        String[] names = PPerson.split(name);
        if (names.length == 2) {
            setLastName(names[0]);
     ...
     */
    @Override
    public int compareTo(PPerson otherPerson) {
        if (this == otherPerson) {
            return 0;
        }
    ...
    public static PPerson fromName(String properName) {
        String[] split = split(properName);
        if (split.length > 1) {
            return new PPerson(split[0], split[1], null);
        } else {
            return new PPerson("", properName, null);
        }
    }
