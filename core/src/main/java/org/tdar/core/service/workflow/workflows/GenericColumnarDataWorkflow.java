...
public class GenericColumnarDataWorkflow extends BaseWorkflow {
    ...
    public GenericColumnarDataWorkflow() {
        ...
        getRequiredExtensions().put("shp", Arrays.asList("dbf", "sbn", "sbx", "shp.xml", "shx", "xml", "lyr"));
    ...
    @Override
    public void initializeWorkflowContext(WorkflowContext ctx, InformationResource resource, InformationResourceFileVersion[] version) {
