...
public @interface BulkImportField {
	public static final String FILENAME_DESCRIPTION = "List each file you would like to upload individually.  A new metadata record will be created for every file listed.  Note:  the filenames MUST match the actual file names you uploaded on the \"New Batch Upload\" screen.";
    ...
    public static final String METADATA_LANGUAGE_DESCRIPTION = "Metadata language - Language of record metadata you entered- NOT language as it refers to the actual file.";
    ...
    public static final String CREATOR_PERSON_INSTITUTION_DESCRIPTION = "The creator/ author/ sponsor's / etc. associated institution.  NOTE: This does field does not refer to the submitter/creator of the metadata record -which  is an automatically populated field. ";
