...
function displayAsyncError(handler, msg) {
	var errorMsg = ("<p>The system experienced errors while uploading your file.  Please try again, or if the error persists, please save this record without the "
			+ " file attachment and notify an Administrator.</p>");
	if (msg)
		errorMsg = msg;
