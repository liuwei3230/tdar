...
<#macro resourceCollectionSection>
   <div style="display:none" id="divResourceCollectionListTips">
    ...
    <p tiplabel="${siteAcronym} Collections" tooltipcontent="#divResourceCollectionListTips">
        <em>Collections enable you to organize and share resources within ${siteAcronym}</em>
...
<div class="glide" id="divResourceProvider" tiplabel="Resource Provider" tooltipcontent="The institution authorizing ${siteAcronym} to ingest the resource for the purpose of preservation and access.">
...
<#if copyrightMandatory>
    ...
    <#else>
        ...
        <tr><td>
			<input type="radio" id="copyright_holder_type_person" name="copyrightHolderType" value="Person" <#if copyrightHolderProxy.actualCreatorType=='PERSON'>checked='checked'</#if> onchange="toggleCopyrightHolder();"/>
            ...
            <span class="creatorPerson" id="copyrightPerson">
                ...
                <div class="width30percent marginLeft10" >
					...
					<@s.textfield id="copyright_holder_person_last_name" cssClass="nameAutoComplete ${person_name_required!}" watermark="Last Name"
		                ...
		                name="copyrightHolderProxy.person.lastName" value="${(copyrightHolderProxy.person.lastName)!}" maxlength="255" autocomplete="off" 
                    ...
                    <@s.textfield id="copyright_holder_person_first_name" cssClass="nameAutoComplete  ${person_name_required!}" watermark="First Name"
						...
						name="copyrightHolderProxy.person.firstName" value="${(copyrightHolderProxy.person.firstName)!}" maxlength="255" autocomplete="off" 
	                ...
	                <@s.textfield cssClass="nameAutoComplete" watermark="Email"
						...
						name="copyrightHolderProxy.person.email" value="${(copyrightHolderProxy.person.email)!}" maxlength="255" autocomplete="off"/>
                    <br />
                </div>
                <div class="width60percent marginLeft10">
...
<div class="glide" id="license_section">
	...
	<#list licenseTypesList as licenseCursor>
    		...
    		<label for="license_radio_button_${licenseCursor}">${licenseCursor.licenseName}</label><br/>
	</#list>
