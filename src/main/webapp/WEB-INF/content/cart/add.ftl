                ...
                <div id="custom" class="tab-pane <#if !showSuggested>active</#if>">
                    <div class="row">
                        <div class="col-xs-8">
                            ...
                            <div class="well">
                                <@s.textfield name="invoice.numberOfFiles" label="Number of Files" cssClass="integer col-xs-2 orderinfo" maxlength=9  />

                                <div class="control-group">
                                    <label class="control-label">Number of Mb</label>

                                    <div class="controls">
                                        <@s.textfield name="invoice.numberOfMb" label="Number of Mb"  theme="simple" cssClass="integer col-xs-2 orderinfo" maxlength=9 />
            ...
            <#list activities as act>
                <#if !act.production >
                    <tr>
                        ...
                        <td><@s.textfield name="extraItemQuantities[${act_index}]" cssClass="integer col-xs-2 orderinfo" theme="simple"/></td>
                    </tr>
                </#if>
            </#list>
            </tbody>
