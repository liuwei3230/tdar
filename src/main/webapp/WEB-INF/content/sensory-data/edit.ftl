            ...
            <#list _scans as _scan>
                <div id="sensoryDataScanRow_${_scan_index}_" class='repeat-row'>
                    ...
                    <span data-tiplabel="Scan Filename"
                        ...
                        <@s.textfield theme='simple' maxLength="255" name="sensoryDataScans[${_scan_index}].filename" placeholder="Filename" cssClass="col-xs-3 shortfield" />
                    </span>
                            <#assign _scanDate="" />
                            <#if _scan.scanDate?? >
                            ...
                            <span data-tiplabel="Scan Date" data-tooltipcontent="Date the object/monument was scanned">
                                <@s.textfield maxLength="255" theme='simple' name="sensoryDataScans[${_scan_index}].scanDate" value="${_scanDate}" placeholder="mm/dd/yyyy" cssClass="col-xs-2 date" />
                            </span>
                    ...
                    <span data-tiplabel="Data Resolution" data-tooltipcontent="Fixed resolution or data resolution at specific range.">
                        <@s.textfield maxLength="255" theme='simple' name="sensoryDataScans[${_scan_index}].resolution" placeholder="Resolution" cssClass="col-xs-3" />
                    </span>
                    <span data-tiplabel="Number of Points in Scan" data-tooltipcontent="Number of points generated in scan">
                        <@s.textfield theme='simple' maxLength="255" name="sensoryDataScans[${_scan_index}].pointsInScan" placeholder="# points" cssClass="col-xs-2 shortfield number" />
                    </span>
                        </div>
                        <div class='controls controls-row'>
                    <span data-tiplabel="Scan Transformation Matrix"
                        ...
                        <@s.textfield maxLength="255" theme='simple' name="sensoryDataScans[${_scan_index}].transformationMatrix" placeholder="Transformation Matrix" cssClass="col-xs-3" />
                    </span>
