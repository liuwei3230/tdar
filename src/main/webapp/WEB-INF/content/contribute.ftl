...
<hr />
    ...
    <@s.form name='MetadataForm' id='MetadataForm'  method='post' cssClass="form-horizontal disableFormNavigate" enctype='multipart/form-data' action='/cart/process-choice'>
                               <@s.hidden name="invoice.numberOfFiles" label="Number of Files" cssClass="integer col-xs-2" maxlength=9  />
                               <@s.hidden name="invoice.numberOfMb" label="Number of Mb"  theme="simple" cssClass="integer col-xs-2" maxlength=9 />
...
<div class="row">
    <div class="col-xs-6">Should you have sensitive materials, you have a number of options for protecting it in tDAR:
        <ul>
    ...
    <div class="col-xs-6"><a href="http://www.tdar.org/wp-uploads/www.tdar.org//2012/10/bg-rights.png"><img alt="" class="alignnone size-full wp-image-161" height="279" src="http://www.tdar.org/wp-uploads/www.tdar.org//2012/10/bg-rights.png" title="bg-rights" width="477"></a></div>
</div>
...
<div class="row">
    <div class="col-xs-6">As you collect your data and digital documents, keep these important things in mind:
        <ul>
    ...
    <div class="col-xs-6">What to put into tDAR:
