...
public class SpatialSearchITCase extends AbstractWithIndexIntegrationTestCase {
    ...
    @Test
    @Rollback
    public void testGeoDocScale() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    public void testGeoSearchFoundWhenSpanningPrimeMeridian() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    @Rollback
    // a document within a search's geobound should be found when geobounds span the prime meridian
    public void testGeoSearchFoundWhenSpanningPrimeMeridian2() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    public void testGeoSearchNotFoundWhenSpanningPrimeMeridian() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    @Rollback
    // a document to the west of a search's geobounds should not be found when geobounds span the prime meridian
    public void testGeoSearchNotFoundWhenSpanningPrimeMeridianLondon() throws SearchException, SearchIndexException, IOException, ParseException {
        // document w/ coords that are outside of our search (within lat coords but east of long coords)
    ...
    @Test
    @Rollback
    public void testGeoSearchFoundWhenSpanningAntiMeridian() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    @Test
    @Rollback
    public void testGeoSearchThatSpansChile() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    @Test
    @Rollback
    public void testGeoSearchThatSpansGreenland() throws SearchException, SearchIndexException, IOException, ParseException {
    ...
    private void testItemIsFoundByBox(LatitudeLongitudeBox latitudeLongitudeBoxOfItem, LatitudeLongitudeBox latitudLongitudeBoxOfQuery)
            ...
            IllegalAccessException, SearchException, SearchIndexException, IOException, ParseException {
