...
public interface DatasetMappingService {
     ...
     */
    void remapColumnsAsync(DataTable table, List<DataTableColumn> columns, Project project);

    void remapColumns(DataTable table, List<DataTableColumn> columns, Project project);
